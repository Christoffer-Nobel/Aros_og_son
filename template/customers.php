...
<tr><td><a href="?t=<?php echo $row["customer_id"]; ?>"><?php echo $row['firstname'] . " " . $row['lastname']?></a><?php
echo "</td><td>" . $row['company_name'] . "</td><td>" . $row['email'] . "</td><td>" . $row['phone_number'] . "</td></tr>";  //$row['index'] the index here is a field name
}
